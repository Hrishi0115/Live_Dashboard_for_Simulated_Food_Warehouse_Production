...
next_package_time = 0
package_interval = 500  # milliseconds, approx 120/min
...
while running:
    ...
    # Generate new packages at more frequent intervals
    if current_time > next_package_time:
        ...
        next_package_time = current_time + package_interval
    ...
    for package in active_packages[:]:
        package['pos'][0] += random.randint(1, 5)  # Vary the speed slightly for natural movement
